...
from .sect_serializer import CREATESectSerializer, UPDATESectSerializer, GETSectDetailsByIdSerializer, GETAllSectSerializer, GETAllSectForDropDownSerializer, GETAllSectWithCountForResidentsSerializer

...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0008_delete_notificationhistory'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notificationId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notification', to='accounts.notification')),
